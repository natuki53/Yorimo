...
spotRouter.post("/", requireAuth, validateBody(spotCreateSchema), asyncHandler(createSpot));
...
spotRouter.patch("/:id", requireAuth, validateParams(idParamSchema), validateBody(spotUpdateSchema), asyncHandler(updateSpot));
spotRouter.delete("/:id", requireAuth, validateParams(idParamSchema), asyncHandler(deleteSpot));
